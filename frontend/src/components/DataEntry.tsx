  ...
  const handleSaveDowntime = async () => {
    ...
    if (editingDowntimeId) {
      ...
      if (shouldChangeDie && newDieSelection) {
        ...
        toast.success(`Die changed: ${oldDie} → ${newDieSelection}`, {
          duration: 3000,
  ...
  return (
    ...
    <div className="max-w-6xl mx-auto space-y-6">
      ...
      <div ref={inspectionSectionRef} className="scroll-mt-[200px]">
        ...
        >
        <CardHeader className={`bg-gradient-to-r from-blue-50 to-indigo-50 transition-all duration-500 ${
          inspectionHighlight ? 'bg-gradient-to-r from-blue-100 to-indigo-100' : ''
        }`}>
                ...
                <div className="space-y-3">
                  ...
                  <div className="space-y-2">
                    <Input
                      ...
                      className={`h-16 text-xl font-bold border-2 border-yellow-400 transition-all ${
                        startTimeHighlight ? 'ring-4 ring-blue-400 border-blue-500 bg-blue-50' : ''
                      }`}
                    />
                    <Button
                      type="button"
                ...
                <div className="space-y-3">
                  ...
                  <div className="space-y-2">
                    <Input
                      ...
                      className={`h-16 text-xl font-bold border-2 border-yellow-400 transition-all ${
                        endTimeHighlight ? 'ring-4 ring-blue-400 border-blue-500 bg-blue-50' : ''
                      }`}
                    />
                    <Button
                      type="button"
